...
tab_test_mlr_gen = table(pred, data_test$gender)

precision_mlr_gen = round(precision(tab_test_mlr_gen),2)
recall_mlr_gen = round(recall(tab_test_mlr_gen),2)

plot_stats(tab_test_mlr_gen, cf = T)
```
...
tab_test_rda_gen = table(pred$class, data_test$gender)

precision_rda_gen = round(precision(tab_test_rda_gen),2)
recall_rda_gen = round(recall(tab_test_rda_gen),2)

plot_stats(tab_test_rda_gen, cf = T)
```
...
vec_acc_model_gen = c((round(accuracy(tab_test_mlr_gen),2)),
                      #(round(accuracy(tab_test_knn),2)),
                      ...
                      (round(accuracy(tab_test_rda_gen),2)))
