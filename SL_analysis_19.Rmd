...
```{r}
m = subset(data_u85, gender == 1)
f = subset(data_u85, gender == 2)

a = subset(m, age_groups == 1)
full_a = sample_sub(a,0.5)

b = subset(m, age_groups == 2)
full_b = sample_sub(b, 0.5)

c = subset(m, age_groups == 3)
full_c = sample_sub(c, 0.5)

d = subset(m, age_groups == 4)
full_d = sample_sub(d, 0.5)

data_train = rbind(full_a[[1]], full_b[[1]], full_c[[1]], full_d[[1]])
data_test = rbind(full_a[[2]], full_b[[2]], full_c[[2]], full_d[[2]])

data_train_m = rbind(full_a[[1]], full_b[[1]], full_c[[1]], full_d[[1]])
data_test_m = rbind(full_a[[2]], full_b[[2]], full_c[[2]], full_d[[2]])

data_train = rbind(data_train, data_train_m)
data_test = rbind(data_test, data_test_m)

rm(full_a, full_b, full_c, full_d, data_train_m, data_test_m, a, b, c, d)
```
