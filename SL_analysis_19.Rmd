...
df_prob_1 = as.data.frame(predict(rf_100, newdata = 
                                    subset(data_test, select =
                                             -c(age_groups)), type='prob'))

df_prob_2 = as.data.frame(predict(rf_50, newdata = 
                                    subset(data_test, select = 
                                             -c(age_groups)), type='prob'))

df_prob_3 = as.data.frame(predict(rf_10, newdata = 
                                    subset(data_test, select = 
                                             -c(age_groups)), type='prob'))
...
```{r}
par(mfrow=c(1,2))
c1 = density(data_2019[data_2019$age_groups == 1,]$month, adjust = 3.5)
c2 = density(data_2019[data_2019$age_groups == 2,]$month, adjust = 3.5)
c3 = density(data_2019[data_2019$age_groups == 3,]$month, adjust = 3.5)
c4 = density(data_2019[data_2019$age_groups == 4,]$month, adjust = 3.5)
