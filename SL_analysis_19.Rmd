...
sub_data = subset(sub_data, select = -c(age, birth.year, year))
```
...
```{r}
X = subset(sub_data, select = -c(start.station.id,
                                 start.station.name,
                                 end.station.id,
                                 end.station.name,
                                 bikeid,
...
```{r}
sub_data1 = subset(sub_data, select = -c(start.station.name, end.station.name))
