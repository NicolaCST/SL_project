...
```{r}
rf_model_gender = readRDS("rf_for_gender.rda")

data_no_gender = data_2020[data_2020$gender == 0,]
data_gender = data_2020[data_2020$gender != 0,]

y_gender = predict(rf_model_gender, newdata = subset(data_no_gender, select = -c(gender)))
data_no_gender$gender = y_gender

data_2020 = rbind(data_gender, data_no_gender)
