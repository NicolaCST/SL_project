...
get_balanced_dataset = function(data, w_gender=0){
  ...
  if (w_gender != 0){
    a = subset(data, age >= 16 & age < 30 & gender != 0)
    b = subset(data, age >= 30 & age < 40 & gender != 0)
    c = subset(data, age >= 40 & age < 60 & gender != 0)
    d = subset(data, age >= 60 & age <= 80 & gender != 0)
  }else{
...
sub_data$age_groups = cut(sub_data$age, breaks=c(16, 25, 35, 45, 55, 65, 75, 80), include.lowest = TRUE, labels = FALSE)
