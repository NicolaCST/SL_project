...
hist(data[data$age == 1,]$month, prob=TRUE, breaks = 12)
lines(density(data[data$age == 1,]$month, adjust = 3.5), col = "red")
hist(data[data$age == 2,]$month, prob=TRUE, breaks = 12)
lines(density(data[data$age == 2,]$month, adjust = 3.5), col = "red")
hist(data[data$age == 3,]$month, prob=TRUE, breaks = 12)
lines(density(data[data$age == 3,]$month, adjust = 3.5), col = "red")
hist(data[data$age == 4,]$month, prob=TRUE, breaks = 12)
lines(density(data[data$age == 4,]$month, adjust = 1.7), col = "red")


ggplot(data, aes(x=month, fill=age)) + geom_histogram()
data$age
```
