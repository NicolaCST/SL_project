...
temp = order(colSums(tab), decreasing = T)
...
#rstudio_viewer("BostonMap.html", getwd())
```
...
# Model accuracy
mean(prediciton$class==data_test$age)
...
get_balanced_dataset = function(data){
...
full = get_balanced_dataset(data)
...
# Model accuracy
mean(prediciton$class==data_test$gender)
