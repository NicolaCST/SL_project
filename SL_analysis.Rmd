...
plot(c1, xlim = c(1,12), main = "age density over months")
lines(c2)
lines(c3)
lines(c4)

our_palette = c(rgb(1, 0, 0, alpha = 0.25), 
              rgb(0, 1, 0, alpha = 0.25), 
              rgb(0, 0, 1, alpha = 0.25), 
              rgb(1, 0.5, 0, alpha = 0.25))
...
# Fill the areas
polygon(c1, col = our_palette[1])
polygon(c2, col = our_palette[2])
polygon(c3, col = our_palette[3])
polygon(c4, col = our_palette[4])
