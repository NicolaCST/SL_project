...
dic = colnames(tripdata_2019_r)
ven = colnames(tripdata_2020_r) #Remark: 2020 dataset has PostalCode, while 2019 no

setdiff(dic, ven)
```
```{r}
write.csv(tripdata_2019_r, "C:/Users/Utente/Desktop/SL_project/tripdata_2020_r.csv", row.names = FALSE)
```
