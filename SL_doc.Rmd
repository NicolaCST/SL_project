...
print("% of trips between months in 2019", ratio = round((as.integer(between_month) / as.integer(nrow(tripdata_2019_r))) * 100, 3))
...
```{r}
months_19 = table(tripdata_2019_r$month)

freq_month_19 = barplot(data, 
...
text(x = min_per_month_19, y = mean_dur_19 + 0.5, labels = mean_dur_19, cex=0.8)
