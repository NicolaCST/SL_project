...
#Let's try to predict the 0-age 
```{r}
discover = subset(sub_data, select = -c(year, 
                                        birth.year, 
                                        #startday, 
                                        stopday,
                                        #end.station.id,  
...
discover = discover[discover$age == 0,]
discover = subset(discover, select = -c(age))
...
hist(tripdata_2020_r$age, 
     breaks = 20,
     xlab = "Age",
     main = "Age Histogram 2020")


dens = density(tripdata_2020_r$age)
plot(dens,main = "Age density 2020")
